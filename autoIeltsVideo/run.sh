...
#    echo "  splitAudio/split:         audioFile time"
  ...
  if [ $1 = "main" ]; then
    ...
    FAKED_LEFT_VIDEO=$FAKED_DIR$LEFT_VIDEO_SRC_FILENAME"_"$AUDIO_SRC_FILENAME"s-1."$LEFT_VIDEO_SRC_FILE_EXT
    FAKED_RIGHT_VIDEO=$FAKED_DIR$RIGHT_VIDEO_SRC_FILENAME"_"$AUDIO_SRC_FILENAME"s-2."$RIGHT_VIDEO_SRC_FILE_EXT
...
#    fi
    ...
    #一把合并好
    FINAL_SPEC_NAME=$RESULT_DIR$LEFT_VIDEO_SRC_FILENAME"_"$RIGHT_VIDEO_SRC_FILENAME"_"$AUDIO_SRC_FILENAME"."$LEFT_VIDEO_SRC_FILE_EXT
